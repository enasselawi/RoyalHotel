...
namespace RoyalHotel.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomId,HotelId,RoomType,Price,Capacity,Booked")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("RoomId,HotelId,RoomType,Price,Capacity,Booked")] Room room)
        {
            if (id != room.RoomId)
            {
                return NotFound();
