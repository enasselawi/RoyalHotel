...
namespace RoyalHotel.Controllers
{
    public class FootersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SectionName,Content")] Footer footer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,SectionName,Content")] Footer footer)
        {
            if (id != footer.Id)
            {
                return NotFound();
